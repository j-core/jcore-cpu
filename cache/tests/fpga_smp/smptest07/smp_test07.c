...
/* --------------------------------------------------------------- */
/* smp_test05.c  O. Nishii 2015-05-14                              */
...
/*           IRQ3 INTERRUPT CODE */
#define IRQ3_INTCODE     0x14
/*           reference aic.vhd line 58 */
/*           constant v_irq : v_irq_t := (x"11", x"12", x"13", x"14", ... */
...
/*  |  +0x520 * CPU1 IPI interrupt handler (instr) (0x190) sm05c1i.xxd       */
/*  |  +0x320 * CPU1 main program (instr)          ( 0xd0) sm05c1a.xxd       */
/*  |  +0x120 * CPU0 IPI interrupt handler (instr) (0x150) sm05c0i.xxd       */
