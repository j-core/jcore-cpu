...
architecture rom of decode_table is
    ...
    90 => x"000000005230022000", 91 => x"000000518480000400", 92 => x"000000410080ae4000", 93 => x"048040400000000000", 94 => x"024000618080015000", -- CAS Rm, Rn, @R0
    95 => x"8240400112913e4000", -- DIV1 Rm, Rn
    96 => x"024040010081424000", -- DIV0S Rm, Rn
    97 => x"024064010080024330", -- DMULS.L Rm, Rn
    98 => x"024064010080024338", -- DMULU.L Rm, Rn
    99 => x"024040001255024000", -- EXTS.B Rm, Rn
    100 => x"024040001255824000", -- EXTS.W Rm, Rn
    101 => x"024040001256024000", -- EXTU.B Rm, Rn
    102 => x"024040001256824000", -- EXTU.W Rm, Rn
    103 => x"024040001230024000", -- MOV Rm, Rn
    104 => x"024064010080024340", -- MUL.L Rm, Rn
    105 => x"024064010080024348", -- MULS.W Rm, Rn
    106 => x"024064010080024350", -- MULU.W Rm, Rn
    107 => x"0240c0001311824000", -- NEG Rm, Rn
    108 => x"2240c0001311a64000", -- NEGC Rm, Rn
    109 => x"0240c0001307024000", -- NOT Rm, Rn
    110 => x"024040011287824000", -- OR Rm, Rn
    111 => x"024040011291824000", -- SUB Rm, Rn
    112 => x"224040011291a64000", -- SUBC Rm, Rn
    113 => x"024040011291aa4000", -- SUBV Rm, Rn
    114 => x"024040001258024000", -- SWAP.B Rm, Rn
    115 => x"024040001258824000", -- SWAP.W Rm, Rn
    116 => x"0240400100822e4000", -- TST Rm, Rn
    117 => x"024040011280824000", -- XOR Rm, Rn
    118 => x"0240400112d9024000", -- XTRACT Rm, Rn
    119 => x"0240400112c4024000", -- SHAD Rm, Rn
    120 => x"0240400112c3824000", -- SHLD Rm, Rn
    121 => x"0240c0a10091026c00", -- MOV.B Rm, @Rn
    122 => x"0240c0a10091027400", -- MOV.W Rm, @Rn
    123 => x"0240c0a10091027000", -- MOV.L Rm, @Rn
    124 => x"024040900430024800", -- MOV.B @Rm, Rn
    125 => x"024040900430025800", -- MOV.W @Rm, Rn
    126 => x"024040900430024400", -- MOV.L @Rm, Rn
    127 => x"000000011291004780", 128 => x"000038026291004458", 129 => x"024040000000000000", -- MAC.L @Rm+, @Rn+
    130 => x"000200011291005b80", 131 => x"024278026291005860", -- MAC.W @Rm+, @Rn+
    132 => x"000100026291004000", 133 => x"024140920491804800", -- MOV.B @Rm+, Rn
    134 => x"000200026291004000", 135 => x"024240920491805800", -- MOV.W @Rm+, Rn
    136 => x"000000026291004000", 137 => x"024040920491804400", -- MOV.L @Rm+, Rn
    138 => x"024140a11291826c00", -- MOV.B Rm,@-Rn
    139 => x"024240a11291827400", -- MOV.W Rm,@-Rn
    140 => x"024040a11291827000", -- MOV.L Rm,@-Rn
    141 => x"024040a10091028c00", -- MOV.B Rm, @(R0, Rn)
    142 => x"024040a10091029400", -- MOV.W Rm, @(R0, Rn)
    143 => x"024040a10091029000", -- MOV.L Rm, @(R0, Rn)
    144 => x"02404092049102a800", -- MOV.B @(R0, Rm), Rn
    145 => x"02404092049102b800", -- MOV.W @(R0, Rm), Rn
    146 => x"02404092049102a400", -- MOV.L @(R0, Rm), Rn
    147 => x"024540960491004800", -- MOV.B @(disp, Rm), R0
    148 => x"0245c0960491005800", -- MOV.W @(disp, Rm), R0
    149 => x"024540a2009102cc00", -- MOV.B R0, @(disp, Rn)
    150 => x"0245c0a2009102d400", -- MOV.W R0, @(disp, Rn)
    151 => x"024640a10091027000", -- MOV.L Rm, @(disp, Rn)
    152 => x"024640920491004400", -- MOV.L @(disp, Rm), Rn
    153 => x"0246c0a2809102cc00", -- MOV.B R0, @(disp, GBR)
    154 => x"024740a2809102d400", -- MOV.W R0, @(disp, GBR)
    155 => x"0247c0a2809102d000", -- MOV.L R0, @(disp, GBR)
    156 => x"0246c0968491004800", -- MOV.B @(disp, GBR), R0
    157 => x"024740968491005800", -- MOV.W @(disp, GBR), R0
    158 => x"0247c0968491004400", -- MOV.L @(disp, GBR), R0
    159 => x"c247c0007391008000", -- MOVA @(disp, PC), R0
    160 => x"064840000191008005", 161 => x"006000000000000000", 162 => x"024040000000000000", -- BF label
    163 => x"06c840000191008005", 164 => x"0a6000000000000000", -- BF /S label
    165 => x"044840000191008006", 166 => x"006000000000000000", 167 => x"024040000000000000", -- BT label
    168 => x"048840000191008006", 169 => x"0a6000000000000000", -- BT /S label
    170 => x"0008c0000191008002", 171 => x"0a6000000000000000", -- BRA label
    172 => x"0008c0004391008004", 173 => x"0a6000000000000000", -- BSR label
    174 => x"024740900591009800", -- MOV.W @(disp, PC), Rn
    175 => x"c247c0900591008400", -- MOV.L @(disp, PC), Rn
    176 => x"0000009a849102e800", 177 => x"00000002d29102e000", 178 => x"0246c1000082030c00", -- AND.B #imm, @(R0, GBR)
    179 => x"0000009a849102e800", 180 => x"00000002d29102e000", 181 => x"0246c1000087830c00", -- OR.B #imm, @(R0, GBR)
    182 => x"0000009a849102e800", 183 => x"000000000000000000", 184 => x"0246c00000822c4000", -- TST.B #imm, @(R0, GBR)
    185 => x"0000009a849102e800", 186 => x"00000002d29102e000", 187 => x"0246c1000080830c00", -- XOR.B #imm, @(R0, GBR)
    188 => x"0246c001f282008000", -- AND #imm, R0
    189 => x"024940018080ac8000", -- CMP /EQ #imm, R0
    190 => x"0246c001f287808000", -- OR #imm, R0
    191 => x"0246c00180822c8000", -- TST #imm, R0
    192 => x"0246c001f280808000", -- XOR #imm, R0
    193 => x"000000a08291817000", 194 => x"000000a08291833000", 195 => x"00078080011100e400", 196 => x"000000000000000000", 197 => x"000000000020000002", 198 => x"006000000000000000", 199 => x"024040000000000000", -- TRAPA #imm
    200 => x"024940011291008000", -- ADD #imm, Rn
    201 => x"024940001230008000", -- MOV #imm, Rn
    202 => x"000200000191804002", 203 => x"000000a08291817000", 204 => x"000000a08291833000", 205 => x"00078080011100e400", 206 => x"000000000000000000", 207 => x"000000000020000002", 208 => x"006000000000000000", 209 => x"024040000000000000", -- General Illegal
    210 => x"000080000191004002", 211 => x"000000a08291817000", 212 => x"000000a08291833000", 213 => x"00078080011100e400", 214 => x"000000000000000000", 215 => x"000000000020000002", 216 => x"006000000000000000", 217 => x"024040000000000000", -- Slot Illegal
    218 => x"000000000000000000", 219 => x"010000000000000000", 220 => x"000780805230008400", 221 => x"0000009f0491004400", 222 => x"000000000020000002", 223 => x"006000003280802000", 224 => x"024040000000000000", -- Reset
    225 => x"011200000191804002", 226 => x"c0008000d291004000", 227 => x"000000a35291817000", 228 => x"000000a35291833000", 229 => x"000780838091008400", 230 => x"000000008291c44000", 231 => x"000000000020000002", 232 => x"006000008291804000", 233 => x"024040000000000000", -- Interrupt
    234 => x"011200000191804002", 235 => x"c0008000d291004000", 236 => x"000000a35291817000", 237 => x"000000a35291833000", 238 => x"000780838091008400", 239 => x"000000008291804000", 240 => x"000000000020000002", 241 => x"006000008291804000", 242 => x"024040000000000000", -- Error
    243 => x"000000000000000000", 244 => x"100200000191804002", 245 => x"006000000000000000", 246 => x"024040000000000000", -- Break
    247 => x"000000000000000000", 248 => x"000000000000000000", 249 => x"000000000000000000", 250 => x"000000000000000000", 251 => x"000000000000000000", 252 => x"000000000000000000", 253 => x"000000000000000000", 254 => x"000000000000000000", 255 => x"000000000000000000");
begin
    ...
    with line(12 downto 10) select
        ex_stall.ma_issue <=
            '1' when "001" | "010" | "011" | "100" | "101" | "110",
            '0' when others;
    with line(12 downto 10) select
        ex.ma_wr <=
            '1' when "011" | "100" | "101",
